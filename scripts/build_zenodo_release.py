...
ROOT_FILES = [
    ...
    "ZENODO_UPLOAD.md",
    "paper_core.py",
    "paper_core_standalone.py",
    "pyproject.toml",
    "_fig4_curve_plotting.py",
    "_protein_mdctf_curve.py",
    "_protein_mdctf_mc.py",
    "_protein_mdctf_optimized_curve.py",
    "gene_power_workflow.py",
    "logistic_fit.py",
    "pcam_gen.py",
    "phylofunc_fast.py",
    "protein_power_workflow.py",
    "protein_transforms.py",
    "semisynthetic_power.py",
]
...
PACKAGE_FILES = [
    ...
    "phylopower/_data.py",
    "phylopower/_paper_core_source.py",
    "phylopower/paper_core.py",
...
SUPPORT_FILES = [
    ...
    "tests/test_paper_core_release.py",
