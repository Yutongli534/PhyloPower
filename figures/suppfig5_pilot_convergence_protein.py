#!/usr/bin/env python3
"""Supplementary Figure S5 - metaproteomic pilot-information convergence.

Two diagnostic panels for the PRIDE PXD069517 pilot-information convergence
analysis (counterpart of Supplementary Figure S1, which covers the
metagenomic side). Only plots from the archived metrics table
(validation_datasets/results/PXD069517_pilot_information/, produced by
analysis/run_pilot_information_supplement_protein_pxd.py).

Style (Arial, palette, box+points layout) matches
``suppfig1_pilot_convergence_gene.py``.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-png", type=Path, default=OUT_DIR / "suppfig5_pilot_convergence_protein.png")
    parser.add_argument("--out-pdf", type=Path, default=OUT_DIR / "suppfig5_pilot_convergence_protein.pdf")
