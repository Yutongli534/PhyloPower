#!/usr/bin/env python3
"""Supplementary Figure S1 - metagenomic pilot-information convergence (two panels).

Only plots from the archived metrics table
(data/pilot_information_supplement/pilot_information_curve_metrics.csv,
produced by analysis/run_pilot_information_supplement.py).
"""
...
DATA = ROOT / "data" / "pilot_information_supplement" / "pilot_information_curve_metrics.csv"
OUT_PNG = ROOT / "figures" / "output" / "suppfig1_pilot_convergence_gene.png"
OUT_PDF = ROOT / "figures" / "output" / "suppfig1_pilot_convergence_gene.pdf"
PILOTS = [4, 7, 10]
